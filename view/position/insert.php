...
?>
    ...
    <div class="jumbotron">
        <div class="container" style="text-align: center">
            <h1 class="display-4">Dodavanje nove pozicije</h1>
        </div>
    </div>
...
?>
    ...
    <div class="container col-md-5">
        ...
        <div class="card container">
            <form action="/position/insert/" method="post" novalidate autocomplete="off">
                <div class="form-row">
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control" id="name" placeholder="Naziv" name="name"
                               value="<?php if (isset($position)) echo $position->getName(); ?>">
                        <?php

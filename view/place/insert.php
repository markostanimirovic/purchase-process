...
?>
    ...
    <div class="jumbotron">
        <div class="container" style="text-align: center">
            <h1 class="display-4"">Dodavanje novog mesta</h1>
        </div>
    </div>
...
?>
    ...
    <div class="container col-md-5">
        ...
        <div class="card container">
            <form action="/place/insert/" method="post" novalidate autocomplete="off">
                <div class="form-row">
                    <div class="form-group col-md-12">
                        <label for="zip-code" class="col-form-label">Poštanski broj <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="zip-code" placeholder="Poštanski broj"
                               name="zip-code" value="<?php if (isset($place)) echo $place->getZipCode(); ?>">
                        <?php
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control" id="name" placeholder="Naziv" name="name"
                               value="<?php if (isset($place)) echo $place->getName(); ?>">
                        <?php
